# flux_dev_full_text_to_image-2-json

Dockerized ComfyUI workflow: flux_dev_full_text_to_image (2).json
...
docker build -t flux_dev_full_text_to_image-2-json .

# Run the container
docker run -p 8188:8188 flux_dev_full_text_to_image-2-json
```
